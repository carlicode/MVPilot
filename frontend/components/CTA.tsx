    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-mvpilot-black dark:bg-mvpilot-black">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-center text-white/90 mb-8">
          Únete a miles de emprendedores que ya están construyendo con MVPilot
        </p>
        ...
        <div className="grid grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="text-white/80">MVPs Generados</div>
          </div>
          <div>
            <div className="text-4xl font-bold text-white mb-2">$0</div>
            <div className="text-white/80">Para Empezar</div>
          </div>
        </div>
        ...
        <div className="border-t border-white/20 pt-8">
          ...
          <div className="mt-4 text-white/60 text-xs">
            © 2026 MVPilot. Participante en 10,000 AIdeas Competition.
          </div>
        </div>
      </div>
    </section>
